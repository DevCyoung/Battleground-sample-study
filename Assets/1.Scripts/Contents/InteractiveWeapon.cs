...
public class InteractiveWeapon : MonoBehaviour
{
    ...
    public Vector3 relativeRotation;  // 플레이어 오른손에 보정 회전
    ...
    private int fullMag, maxBullets; //재장전시 꽉 채우는 탄의 양과 한번ㅇ 채울수있는 최대 총알
    ...
    private void Awake()
    {
        ...
        {
            muzzelTransform = transform.Find("muzeel");
        }
    ...
    public bool Shoot(bool firstShot = true)
    {
        ...
        {
            SoundManager.Instance.PlayOneShotEffect((int)noBulletSound, muzzelTransform.position, 5f);
        }
        return false;
